...
os.environ['HF_DATASETS_CACHE'] = '/cs/labs/daphna/uri1234/ANLP/'
os.environ['HF_METRICS_CACHE'] = '/cs/labs/daphna/uri1234/ANLP/'
os.environ['HF_MODULES_CACHE'] = '/cs/labs/daphna/uri1234/ANLP/'
os.environ['HF_DATASETS_DOWNLOADED_EVALUATE_PATH'] = '/cs/labs/daphna/uri1234/ANLP/'
os.environ['TRANSFORMERS_CACHE'] = '/cs/labs/daphna/uri1234/ANLP/'
...
for model_name in model_names:
    ...
    for seed in range(args.num_seeds):
        ...
        training_args = TrainingArguments(
            output_dir="/cs/labs/daphna/uri1234/ANLP/EX1/"+model_name+str(seed)+"results",
        )


        # Step 4: Load model and tokenizer
        config = AutoConfig.from_pretrained(model_name, cache_dir = "/cs/labs/daphna/uri1234/ANLP/")
        tokenizer = AutoTokenizer.from_pretrained(model_name, cache_dir = "/cs/labs/daphna/uri1234/ANLP/")
        all_models[-1].append(AutoModelForSequenceClassification.from_pretrained(model_name, config=config, cache_dir = "/cs/labs/daphna/uri1234/ANLP/").cuda())
    ...
    with open("/cs/labs/daphna/uri1234/ANLP/EX1/res.txt", 'a') as f:
...
model.eval()
start = time.time()
with open("/cs/labs/daphna/uri1234/ANLP/EX1/"+model_names[best_model]+str(best_seed)+"results/predictions.txt", 'a') as f:
